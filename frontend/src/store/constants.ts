export enum AppActions {
  ...
  ADD_MEETING_PROPOSAL = "APP/ADD_MEETING_PROPOSAL",
  VOTE_MEETING_PROPOSAL = "APP/VOTE_MEETING_PROPOSAL",
  EXECUTE_MEETING_PROPOSAL = "APP/EXECUTE_MEETING_PROPOSAL",
  UPDATE_CLUB_DEPLOYMENT_LOADING = "APP/UPDATE_CLUB_DEPLOYMENT_LOADING",
}